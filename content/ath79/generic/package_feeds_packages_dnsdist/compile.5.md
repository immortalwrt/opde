---
title: "compile.5"
date: 2021-07-01 16:54:20.593289
hidden: false
draft: false
weight: -5
---
...
make package/feeds/packages/dnsdist/compile -j$(nproc) || make package/feeds/packages/dnsdist/compile V=s
```
...
checking whether we are using the GNU C++ compiler... yes
checking whether ccache_cxx -std=c++17 accepts -g... yes
checking dependency style of ccache_cxx -std=c++17... gcc3
...
checking for crypto_box_curve25519xchacha20poly1305_easy... no
...
make[3]: *** [Makefile:164: /openwrt/build_dir/target-mips_24kc_musl/dnsdist-1.6.0/.configured_ce6f93e91ebd5a882be5ea6561bbd4bd] Error 1
```
