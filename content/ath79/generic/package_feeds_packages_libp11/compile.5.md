---
title: "compile.5"
date: 2021-07-01 17:05:03.350035
hidden: false
draft: false
weight: -5
---
...
make package/feeds/packages/libp11/compile -j$(nproc) || make package/feeds/packages/libp11/compile V=s
```

#### Compile.txt

``` bash
Applying ./patches/001-fix-install.patch using plaintext: 
...
configure: error: libcrypto >= 0.9.8 is required
make[3]: *** [Makefile:66: /openwrt/build_dir/target-mips_24kc_musl/libp11-0.4.11/.configured_68b329da9893e34099c7d8ad5cb9c940] Error 1
```
