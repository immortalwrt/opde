---
title: "compile.5"
date: 2021-07-01 16:55:36.519329
hidden: false
draft: false
weight: -5
---
...
checking for GIO2... no
checking gio/gio.h usability... no
checking gio/gio.h presence... no
checking for gio/gio.h... no
configure: WARNING: glib2 headers not found
checking for g_application_send_notification... configure: WARNING: Cannot link against glib2
...
OPENCT_CFLAGS:           
OPENCT_LIBS:             
PCSC_CFLAGS:             -I/openwrt/staging_dir/target-mips_24kc_musl/usr/include/PCSC 
...
make[7]: Nothing to be done for 'install-exec-am'.
 ...
 /openwrt/staging_dir/host/bin/install -c -m 644 piv-tool opensc-asn1 cardos-tool opensc-notify westcos-tool opensc-explorer pkcs11-register eidenv pkcs11-tool pkcs15-init gids-tool goid-tool dnie-tool cryptoflex-tool pkcs15-crypt openpgp-tool sc-hsm-tool egk-tool iasecc-tool opensc-tool pkcs15-tool netkey-tool npa-tool '/openwrt/build_dir/target-mips_24kc_musl/opensc-0.21.0/ipkg-install/etc/bash_completion.d'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-mips_24kc_musl/opensc-0.21.0/ipkg-install/usr/man/man1'
 /openwrt/staging_dir/host/bin/install -c -m 644 piv-tool.1 opensc-asn1.1 cardos-tool.1 opensc-notify.1 westcos-tool.1 opensc-explorer.1 pkcs11-register.1 eidenv.1 pkcs11-tool.1 pkcs15-init.1 gids-tool.1 goid-tool.1 dnie-tool.1 cryptoflex-tool.1 pkcs15-crypt.1 openpgp-tool.1 sc-hsm-tool.1 egk-tool.1 iasecc-tool.1 opensc-tool.1 pkcs15-tool.1 netkey-tool.1 npa-tool.1 '/openwrt/build_dir/target-mips_24kc_musl/opensc-0.21.0/ipkg-install/usr/man/man1'
make[7]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/opensc-0.21.0/doc/tools'
