---
title: "compile.5"
date: 2021-07-01 17:06:21.014482
hidden: false
draft: false
weight: -5
---
...
subprocess.CalledProcessError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmpmhwug9he', '--quiet', 'wheel']' returned non-zero exit status 2.
...
distutils.errors.DistutilsError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmpmhwug9he', '--quiet', 'wheel']' returned non-zero exit status 2.
