---
title: "compile.5"
date: 2021-07-01 16:51:03.353842
hidden: false
draft: false
weight: -5
---
...
make package/feeds/packages/irssi/compile -j$(nproc) || make package/feeds/packages/irssi/compile V=s
```

#### Compile.txt

``` bash
Applying ./patches/010-Fix-finding-OpenSSL-when-1.1-with-deprecated-APIs-di.patch using plaintext: 
patching file configure.ac
autoreconf: Entering directory `.'
autoreconf: configure.ac: not using Gettext
autoreconf: running: /openwrt/staging_dir/host/bin/aclocal -I /openwrt/staging_dir/target-mips_24kc_musl/host/share/aclocal -I /openwrt/staging_dir/hostpkg/share/aclocal -I /openwrt/staging_dir/target-mips_24kc_musl/usr/share/aclocal -I m4 -I . --force -I m4 ${ACLOCAL_FLAGS}
...
checking for GLIB - version >= 2.28.0... yes (version 2.68.1)
checking for OPENSSL... no
checking for SSL_CTX_new in -lssl... no
configure: error: The OpenSSL library was not found
make[3]: *** [Makefile:66: /openwrt/build_dir/target-mips_24kc_musl/irssi-1.2.2/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
