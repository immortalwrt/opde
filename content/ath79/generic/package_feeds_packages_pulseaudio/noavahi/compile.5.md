---
title: "compile.5"
date: 2021-07-01 17:00:28.160944
hidden: false
draft: false
weight: -5
---
...
Version: 0.57.2
Source dir: /openwrt/build_dir/target-mips_24kc_musl/pulseaudio-noavahi/pulseaudio-14.2
Build dir: /openwrt/build_dir/target-mips_24kc_musl/pulseaudio-noavahi/pulseaudio-14.2/openwrt-build
Build type: cross build
Program git-version-gen found: YES (/openwrt/build_dir/target-mips_24kc_musl/pulseaudio-noavahi/pulseaudio-14.2/git-version-gen)
...
C compiler for the host machine: ccache_cc (gcc 8.4.0 "mips-openwrt-linux-musl-gcc (OpenWrt GCC 8.4.0 r0-57192d1) 8.4.0")
C linker for the host machine: ccache_cc ld.bfd 2.34
C++ compiler for the host machine: ccache_cxx (gcc 8.4.0 "mips-openwrt-linux-musl-g++ (OpenWrt GCC 8.4.0 r0-57192d1) 8.4.0")
...
../../../../build_dir/target-mips_24kc_musl/pulseaudio-noavahi/pulseaudio-14.2/meson.build:659:0: ERROR: Dependency "openssl" not found, tried pkgconfig

A full log can be found at /openwrt/build_dir/target-mips_24kc_musl/pulseaudio-noavahi/pulseaudio-14.2/openwrt-build/meson-logs/meson-log.txt
make[3]: *** [Makefile:304: /openwrt/build_dir/target-mips_24kc_musl/pulseaudio-noavahi/pulseaudio-14.2/.configured_a17fb5ef857664f03cd0ce37cc5ea591] Error 1
```
