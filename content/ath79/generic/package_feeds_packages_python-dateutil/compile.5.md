---
title: "compile.5"
date: 2021-07-01 17:00:28.163110
hidden: false
draft: false
weight: -5
---
...
make package/feeds/packages/python-dateutil/compile -j$(nproc) || make package/feeds/packages/python-dateutil/compile V=s
```
...
subprocess.CalledProcessError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmp0c29dh0c', '--quiet', 'setuptools_scm']' returned non-zero exit status 2.

The above exception was the direct cause of the following exception:

Traceback (most recent call last):
  File "/openwrt/build_dir/target-mips_24kc_musl/pypi/python-dateutil-2.8.1/setup.py", line 49, in <module>
    setup(
...
distutils.errors.DistutilsError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmp0c29dh0c', '--quiet', 'setuptools_scm']' returned non-zero exit status 2.
make[3]: *** [Makefile:43: /openwrt/build_dir/target-mips_24kc_musl/pypi/python-dateutil-2.8.1/.built] Error 1
```
