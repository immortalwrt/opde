---
title: "compile.5"
date: 2021-07-01 17:06:20.975868
hidden: false
draft: false
weight: -5
---
...
make package/feeds/packages/python-ubus/compile -j$(nproc) || make package/feeds/packages/python-ubus/compile V=s
```
...
subprocess.CalledProcessError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmppk_3bjbt', '--quiet', 'pytest-runner']' returned non-zero exit status 2.

The above exception was the direct cause of the following exception:

Traceback (most recent call last):
  File "/openwrt/build_dir/target-mips_24kc_musl/pypi/ubus-0.1.1/setup.py", line 25, in <module>
    setup(
...
distutils.errors.DistutilsError: Command '['/openwrt/staging_dir/hostpkg/bin/python3.9', '-m', 'pip', '--disable-pip-version-check', 'wheel', '--no-deps', '-w', '/openwrt/tmp/tmppk_3bjbt', '--quiet', 'pytest-runner']' returned non-zero exit status 2.
make[3]: *** [Makefile:44: /openwrt/build_dir/target-mips_24kc_musl/pypi/ubus-0.1.1/.built] Error 1
```
