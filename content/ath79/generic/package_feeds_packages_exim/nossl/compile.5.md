---
title: "compile.5"
date: 2021-07-01 17:01:21.558853
hidden: false
draft: false
weight: -5
---
...
make[4]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2'
...
make[4]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2'
make[4]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/build-Linux-mips'
cc buildconfig.c
/bin/sh ../scripts/Configure-config.h "make"
make[5]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/build-Linux-mips'
make[5]: 'buildconfig' is up to date.
make[5]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/build-Linux-mips'
...
cc -o macro_predef
make[4]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/build-Linux-mips'
make[4]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2'
...
debug.c:354:22: warning: passing argument 2 of 'getpeername' from incompatible pointer type [-Wincompatible-pointer-types]
  if (getpeername(fd, sinp, &alen) == 0)
                      ^~~~
In file included from ../../../../../staging_dir/toolchain-mips_24kc_gcc-8.4.0_musl/include/fortify/sys/socket.h:22,
                 from /openwrt/staging_dir/toolchain-mips_24kc_gcc-8.4.0_musl/include/netinet/tcp.h:98,
                 from os.h:80,
                 from exim.h:36,
                 from debug.c:9:
/openwrt/staging_dir/toolchain-mips_24kc_gcc-8.4.0_musl/include/sys/socket.h:339:23: note: expected 'struct sockaddr * restrict' but argument is of type 'struct sockaddr_in *'
...
In file included from ../../../../../staging_dir/toolchain-mips_24kc_gcc-8.4.0_musl/include/fortify/sys/socket.h:22,
                 ...
                 from exim.h:36,
                 from debug.c:9:
/openwrt/staging_dir/toolchain-mips_24kc_gcc-8.4.0_musl/include/sys/socket.h:339:23: note: expected 'struct sockaddr * restrict' but argument is of type 'struct sockaddr_in6 *'
 int getpeername (int, struct sockaddr *__restrict, socklen_t *__restrict);
                       ^
...
In file included from ../../../../../staging_dir/toolchain-mips_24kc_gcc-8.4.0_musl/include/fortify/sys/socket.h:22,
                 ...
                 from exim.h:36,
                 from debug.c:9:
/openwrt/staging_dir/toolchain-mips_24kc_gcc-8.4.0_musl/include/sys/socket.h:339:23: note: expected 'struct sockaddr * restrict' but argument is of type 'struct sockaddr_un *'
 int getpeername (int, struct sockaddr *__restrict, socklen_t *__restrict);
                       ^
ccache_cc deliver.c
...
make[6]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/build-Linux-mips/lookups'
ccache_cc dsearch.c
ccache_cc lsearch.c
ccache_cc spf.c
...
make[6]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/build-Linux-mips/lookups'
make[5]: *** [Makefile:1024: buildlookups] Error 2
make[5]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/build-Linux-mips'
make[4]: *** [Makefile:35: all] Error 2
make[4]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2'
make[3]: *** [Makefile:288: /openwrt/build_dir/target-mips_24kc_musl/exim-nossl/exim-4.94.2/.built] Error 2
```
