---
title: "compile.5"
date: 2021-07-01 17:01:21.560765
hidden: false
draft: false
weight: -5
---
...
make[4]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2'
...
make[4]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2'
make[4]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2/build-Linux-mips'
cc buildconfig.c
/bin/sh ../scripts/Configure-config.h "make"
make[5]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2/build-Linux-mips'
make[5]: 'buildconfig' is up to date.
make[5]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2/build-Linux-mips'
...
cc -o macro_predef
make[4]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2/build-Linux-mips'
make[4]: Entering directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2'
...
make[5]: *** [Makefile:856: exim_dbmbuild.o] Error 1
make[5]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2/build-Linux-mips'
make[4]: *** [Makefile:35: all] Error 2
make[4]: Leaving directory '/openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2'
make[3]: *** [Makefile:288: /openwrt/build_dir/target-mips_24kc_musl/exim-openssl/exim-4.94.2/.built] Error 2
```
