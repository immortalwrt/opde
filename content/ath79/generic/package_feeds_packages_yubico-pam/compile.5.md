---
title: "compile.5"
date: 2021-07-01 16:48:03.268641
hidden: false
draft: false
weight: -5
---
...
make package/feeds/packages/yubico-pam/compile -j$(nproc) || make package/feeds/packages/yubico-pam/compile V=s
```
...
checking for library containing pam_modutil_drop_priv... -lpam
checking pkg-config is at least version 0.9.0... yes
checking for MYSQL... no
configure: WARNING: libmysqlclient not found, will not be compiled (--without-mysql to disable mysql support)
...
make[3]: *** [Makefile:48: /openwrt/build_dir/target-mips_24kc_musl/pam_yubico-2.27/.configured_68b329da9893e34099c7d8ad5cb9c940] Error 1
```
