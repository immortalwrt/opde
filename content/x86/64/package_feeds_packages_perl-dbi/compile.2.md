---
title: "compile.2"
date: 2021-06-30 01:13:08.250033
hidden: false
draft: false
weight: -2
---
...
Looks good
    ...
    I see you're using perl 5.028001 on x86_64-linux-thread-multi, okay.
...
make[4]: Entering directory '/openwrt/build_dir/target-x86_64_musl/perl/DBI-1.643'
...
"/openwrt/staging_dir/hostpkg/usr/bin/perl5.28.1" "/openwrt/staging_dir/hostpkg/usr/lib/perl5/5.28.1/ExtUtils/xsubpp"  -typemap '/openwrt/staging_dir/hostpkg/usr/lib/perl5/5.28.1/ExtUtils/typemap' -typemap '/openwrt/build_dir/target-x86_64_musl/perl/DBI-1.643/typemap'  Perl.xs > Perl.xsc
mv Perl.xsc Perl.c
x86_64-openwrt-linux-gcc -c   -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -Os -pipe -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-x86_64_musl/perl/DBI-1.643=DBI-1.643 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-x86_64_gcc-8.4.0_musl/include -D_REENTRANT -D_GNU_SOURCE -O2   -DVERSION=\"1.643\" -DXS_VERSION=\"1.643\" -fPIC "-I/openwrt/staging_dir/target-x86_64_musl/usr/lib/perl5/5.28/CORE/"  -W -Wall -Wpointer-arith -Wbad-function-cast -Wno-comment -Wno-sign-compare -Wno-cast-qual -Wmissing-noreturn -Wno-unused-parameter Perl.c
...
make[4]: Leaving directory '/openwrt/build_dir/target-x86_64_musl/perl/DBI-1.643'
make[3]: *** [Makefile:67: /openwrt/build_dir/target-x86_64_musl/perl/DBI-1.643/.built] Error 2
```
