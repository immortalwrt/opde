---
title: "compile.3"
date: 2021-06-30 21:09:29.780749
hidden: false
draft: false
weight: -3
---
...
``` bash
Copying files from /openwrt/build_dir/target-aarch64_cortex-a53_musl/mosdns-1.8.6 into /openwrt/build_dir/target-aarch64_cortex-a53_musl/mosdns-1.8.6/.go_work/build/src/github.com/IrineSistiana/mosdns
...
/openwrt/staging_dir/target-aarch64_cortex-a53_musl/usr/share/gocode/src does not exist, skipping symlinks
...
make[3]: *** [Makefile:132: /openwrt/build_dir/target-aarch64_cortex-a53_musl/mosdns-1.8.6/.built] Error 2
```
