---
title: "compile.3"
date: 2021-06-30 21:03:29.439128
hidden: false
draft: false
weight: -3
---
...
make[4]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make  all-recursive
make[5]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
Making all in bstring
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring'
/bin/bash ../libtool  --tag=CC   --mode=compile ccache_cc -DHAVE_CONFIG_H -I. -I.. -I../json   -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include   -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error  -MT bstrlib.lo -MD -MP -MF .deps/bstrlib.Tpo -c -o bstrlib.lo bstrlib.c
OpenWrt-libtool: compile:  ccache_cc -DHAVE_CONFIG_H -I. -I.. -I../json -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error -MT bstrlib.lo -MD -MP -MF .deps/bstrlib.Tpo -c bstrlib.c  -fPIC -DPIC -o .libs/bstrlib.o
...
/bin/bash ../libtool  --tag=CC   --mode=link ccache_cc  -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro  -o libbstring.la -rpath /usr/lib bstrlib.lo  -lrt -lresolv 
OpenWrt-libtool: link: ccache_cc -shared  -fPIC -DPIC  .libs/bstrlib.o   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -lrt -lresolv  -Os -mcpu=cortex-a53 -fstack-protector -Wl,-z -Wl,now -Wl,-z -Wl,relro   -Wl,-soname -Wl,libbstring.so.0 -o .libs/libbstring.so.0.0.0
...
OpenWrt-libtool: link: aarch64-openwrt-linux-musl-gcc-ar cru .libs/libbstring.a  bstrlib.o
/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib/gcc/aarch64-openwrt-linux-musl/8.4.0/../../../../aarch64-openwrt-linux-musl/bin/ar: `u' modifier ignored since `D' is the default (see `U')
OpenWrt-libtool: link: aarch64-openwrt-linux-musl-gcc-ranlib .libs/libbstring.a
OpenWrt-libtool: link: ( cd ".libs" && rm -f "libbstring.la" && ln -s "../libbstring.la" "libbstring.la" )
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring'
Making all in src
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
Making all in linux
make[7]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux'
...
make -C /openwrt/build_dir/target-aarch64_cortex-a53_musl/linux-bcm27xx_bcm2710/linux-5.4.128 M=$PWD;
make[8]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/linux-bcm27xx_bcm2710/linux-5.4.128'
  AR      /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux/built-in.a
  CC [M]  /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux/xt_coova.o
  Building modules, stage 2.
  MODPOST 1 modules
  CC [M]  /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux/xt_coova.mod.o
  LD [M]  /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux/xt_coova.ko
make[8]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/linux-bcm27xx_bcm2710/linux-5.4.128'
rm libxt_coova.o
make[7]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux'
make[7]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
depbase=`echo chilli.lo | sed 's|[^/]*$|.deps/&|;s|\.lo$||'`;\
/bin/bash ../libtool  --tag=CC   --mode=compile ccache_cc -DHAVE_CONFIG_H -I. -I.. -I../json   -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include  -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error  -MT chilli.lo -MD -MP -MF $depbase.Tpo -c -o chilli.lo chilli.c &&\
...
/bin/bash ../libtool  --tag=CC   --mode=link ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro  -o libchilli.la -rpath /usr/lib chilli.lo tun.lo ippool.lo radius.lo md5.lo redir.lo dhcp.lo iphash.lo lookup.lo util.lo options.lo statusfile.lo conn.lo sig.lo garden.lo dns.lo session.lo pkt.lo chksum.lo net.lo safe.lo    sfhash.lo        cmdsock.lo kcoova.lo   ../bstring/libbstring.la      -lrt -lresolv 
OpenWrt-libtool: link: ccache_cc -shared  -fPIC -DPIC  .libs/chilli.o .libs/tun.o .libs/ippool.o .libs/radius.o .libs/md5.o .libs/redir.o .libs/dhcp.o .libs/iphash.o .libs/lookup.o .libs/util.o .libs/options.o .libs/statusfile.o .libs/conn.o .libs/sig.o .libs/garden.o .libs/dns.o .libs/session.o .libs/pkt.o .libs/chksum.o .libs/net.o .libs/safe.o .libs/sfhash.o .libs/cmdsock.o .libs/kcoova.o   -Wl,-rpath -Wl,/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/.libs -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib ../bstring/.libs/libbstring.so -lrt -lresolv  -Os -mcpu=cortex-a53 -fstack-protector -Wl,-z -Wl,now -Wl,-z -Wl,relro   -Wl,-soname -Wl,libchilli.so.0 -o .libs/libchilli.so.0.0.0
...
OpenWrt-libtool: link: aarch64-openwrt-linux-musl-gcc-ar cru .libs/libchilli.a  chilli.o tun.o ippool.o radius.o md5.o redir.o dhcp.o iphash.o lookup.o util.o options.o statusfile.o conn.o sig.o garden.o dns.o session.o pkt.o chksum.o net.o safe.o sfhash.o cmdsock.o kcoova.o
/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib/gcc/aarch64-openwrt-linux-musl/8.4.0/../../../../aarch64-openwrt-linux-musl/bin/ar: `u' modifier ignored since `D' is the default (see `U')
OpenWrt-libtool: link: aarch64-openwrt-linux-musl-gcc-ranlib .libs/libchilli.a
OpenWrt-libtool: link: ( cd ".libs" && rm -f "libchilli.la" && ln -s "../libchilli.la" "libchilli.la" )
depbase=`echo main.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`;\
ccache_cc -DHAVE_CONFIG_H -I. -I.. -I../json   -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include  -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error  -MT main.o -MD -MP -MF $depbase.Tpo -c -o main.o main.c &&\
mv -f $depbase.Tpo $depbase.Po
/bin/bash ../libtool  --tag=CC   --mode=link ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro  -o chilli main.o libchilli.la  ../bstring/libbstring.la         -lrt -lresolv 
OpenWrt-libtool: link: ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF=\"/etc/chilli.conf\" -DDEFPIDFILE=\"/var/run/chilli.pid\" -DDEFSTATEDIR=\"/var/run\" -DSBINDIR=\"/usr/sbin\" -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z -Wl,now -Wl,-z -Wl,relro -DPIC -fPIC -Wno-error -znow -zrelro -o .libs/chilli main.o  -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib ./.libs/libchilli.so /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/.libs/libbstring.so ../bstring/.libs/libbstring.so -lrt -lresolv
depbase=`echo main-response.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`;\
ccache_cc -DHAVE_CONFIG_H -I. -I.. -I../json   -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include  -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error  -MT main-response.o -MD -MP -MF $depbase.Tpo -c -o main-response.o main-response.c &&\
mv -f $depbase.Tpo $depbase.Po
/bin/bash ../libtool  --tag=CC   --mode=link ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro  -o chilli_response main-response.o libchilli.la  ../bstring/libbstring.la         -lrt -lresolv 
OpenWrt-libtool: link: ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF=\"/etc/chilli.conf\" -DDEFPIDFILE=\"/var/run/chilli.pid\" -DDEFSTATEDIR=\"/var/run\" -DSBINDIR=\"/usr/sbin\" -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z -Wl,now -Wl,-z -Wl,relro -DPIC -fPIC -Wno-error -znow -zrelro -o .libs/chilli_response main-response.o  -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib ./.libs/libchilli.so /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/.libs/libbstring.so ../bstring/.libs/libbstring.so -lrt -lresolv
depbase=`echo main-radconfig.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`;\
ccache_cc -DHAVE_CONFIG_H -I. -I.. -I../json   -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include  -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error  -MT main-radconfig.o -MD -MP -MF $depbase.Tpo -c -o main-radconfig.o main-radconfig.c &&\
mv -f $depbase.Tpo $depbase.Po
/bin/bash ../libtool  --tag=CC   --mode=link ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro  -o chilli_radconfig main-radconfig.o libchilli.la  ../bstring/libbstring.la         -lrt -lresolv 
OpenWrt-libtool: link: ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF=\"/etc/chilli.conf\" -DDEFPIDFILE=\"/var/run/chilli.pid\" -DDEFSTATEDIR=\"/var/run\" -DSBINDIR=\"/usr/sbin\" -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z -Wl,now -Wl,-z -Wl,relro -DPIC -fPIC -Wno-error -znow -zrelro -o .libs/chilli_radconfig main-radconfig.o  -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib ./.libs/libchilli.so /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/.libs/libbstring.so ../bstring/.libs/libbstring.so -lrt -lresolv
...
mv -f $depbase.Tpo $depbase.Po
/bin/bash ../libtool  --tag=CC   --mode=link ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro  -o chilli_opt main-opt.o  cmdline.o libchilli.la  ../bstring/libbstring.la         -lrt -lresolv 
OpenWrt-libtool: link: ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF=\"/etc/chilli.conf\" -DDEFPIDFILE=\"/var/run/chilli.pid\" -DDEFSTATEDIR=\"/var/run\" -DSBINDIR=\"/usr/sbin\" -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z -Wl,now -Wl,-z -Wl,relro -DPIC -fPIC -Wno-error -znow -zrelro -o .libs/chilli_opt main-opt.o cmdline.o  -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib ./.libs/libchilli.so /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/.libs/libbstring.so ../bstring/.libs/libbstring.so -lrt -lresolv
depbase=`echo main-query.o | sed 's|[^/]*$|.deps/&|;s|\.o$||'`;\
ccache_cc -DHAVE_CONFIG_H -I. -I.. -I../json   -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/include -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include/fortify -I/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/include  -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error  -MT main-query.o -MD -MP -MF $depbase.Tpo -c -o main-query.o main-query.c &&\
mv -f $depbase.Tpo $depbase.Po
/bin/bash ../libtool  --tag=CC   --mode=link ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF='"/etc/chilli.conf"' -DDEFPIDFILE='"/var/run/chilli.pid"' -DDEFSTATEDIR='"/var/run"' -DSBINDIR='"/usr/sbin"'    -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro  -o chilli_query main-query.o libchilli.la  ../bstring/libbstring.la         -lrt -lresolv 
OpenWrt-libtool: link: ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF=\"/etc/chilli.conf\" -DDEFPIDFILE=\"/var/run/chilli.pid\" -DDEFSTATEDIR=\"/var/run\" -DSBINDIR=\"/usr/sbin\" -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z -Wl,now -Wl,-z -Wl,relro -DPIC -fPIC -Wno-error -znow -zrelro -o .libs/chilli_query main-query.o  -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib ./.libs/libchilli.so /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/.libs/libbstring.so ../bstring/.libs/libbstring.so -lrt -lresolv
make[7]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
Making all in doc
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/doc'
...
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/doc'
Making all in www
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/www'
...
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/www'
Making all in conf
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/conf'
...
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/conf'
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make[5]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make[4]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make[4]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
Making install in bstring
make[5]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring'
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib'
 /bin/bash ../libtool   --mode=install /openwrt/staging_dir/host/bin/install -c   libbstring.la '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib'
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/libbstring.so.0.0.0 /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libbstring.so.0.0.0
OpenWrt-libtool: install: (cd /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib && { ln -s -f libbstring.so.0.0.0 libbstring.so.0 || { rm -f libbstring.so.0 && ln -s libbstring.so.0.0.0 libbstring.so.0; }; })
OpenWrt-libtool: install: (cd /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib && { ln -s -f libbstring.so.0.0.0 libbstring.so || { rm -f libbstring.so && ln -s libbstring.so.0.0.0 libbstring.so; }; })
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/libbstring.lai /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libbstring.la
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/libbstring.a /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libbstring.a
OpenWrt-libtool: install: chmod 644 /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libbstring.a
OpenWrt-libtool: install: aarch64-openwrt-linux-musl-gcc-ranlib /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libbstring.a
OpenWrt-libtool: install: warning: remember to run `libtool --finish /usr/lib'
make[6]: Nothing to be done for 'install-data-am'.
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring'
make[5]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring'
Making install in src
make[5]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
Making install in linux
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux'
make -C /openwrt/build_dir/target-aarch64_cortex-a53_musl/linux-bcm27xx_bcm2710/linux-5.4.128 M=$PWD modules_install;
make[7]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/linux-bcm27xx_bcm2710/linux-5.4.128'
  INSTALL /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux/xt_coova.ko
  DEPMOD  5.4.128
...
mkdir -p /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/iptables/
cp libxt_coova.so /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/iptables/
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src/linux'
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
make[7]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib'
 /bin/bash ../libtool   --mode=install /openwrt/staging_dir/host/bin/install -c   libchilli.la '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib'
OpenWrt-libtool: install: warning: relinking `libchilli.la'
OpenWrt-libtool: install: (cd /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src; /bin/bash /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/libtool  --tag CC --mode=relink ccache_cc -D_GNU_SOURCE -Wall -fno-builtin -fno-strict-aliasing -fomit-frame-pointer -funroll-loops -pipe -I../bstring -DDEFCHILLICONF=\"/etc/chilli.conf\" -DDEFPIDFILE=\"/var/run/chilli.pid\" -DDEFSTATEDIR=\"/var/run\" -DSBINDIR=\"/usr/sbin\" -Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -fmacro-prefix-map=/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6=coova-chilli-1.6 -Wformat -Werror=format-security -fstack-protector -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC -Wno-error -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -znow -zrelro -o libchilli.la -rpath /usr/lib chilli.lo tun.lo ippool.lo radius.lo md5.lo redir.lo dhcp.lo iphash.lo lookup.lo util.lo options.lo statusfile.lo conn.lo sig.lo garden.lo dns.lo session.lo pkt.lo chksum.lo net.lo safe.lo sfhash.lo cmdsock.lo kcoova.lo ../bstring/libbstring.la -lrt -lresolv -inst-prefix-dir /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install)
OpenWrt-libtool: relink: ccache_cc -shared  -fPIC -DPIC  .libs/chilli.o .libs/tun.o .libs/ippool.o .libs/radius.o .libs/md5.o .libs/redir.o .libs/dhcp.o .libs/iphash.o .libs/lookup.o .libs/util.o .libs/options.o .libs/statusfile.o .libs/conn.o .libs/sig.o .libs/garden.o .libs/dns.o .libs/session.o .libs/pkt.o .libs/chksum.o .libs/net.o .libs/safe.o .libs/sfhash.o .libs/cmdsock.o .libs/kcoova.o   -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/usr/lib -L/openwrt/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/lib -L/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib -lbstring -lrt -lresolv  -Os -mcpu=cortex-a53 -fstack-protector -Wl,-z -Wl,now -Wl,-z -Wl,relro   -Wl,-soname -Wl,libchilli.so.0 -o .libs/libchilli.so.0.0.0
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/libchilli.so.0.0.0T /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libchilli.so.0.0.0
OpenWrt-libtool: install: (cd /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib && { ln -s -f libchilli.so.0.0.0 libchilli.so.0 || { rm -f libchilli.so.0 && ln -s libchilli.so.0.0.0 libchilli.so.0; }; })
OpenWrt-libtool: install: (cd /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib && { ln -s -f libchilli.so.0.0.0 libchilli.so || { rm -f libchilli.so && ln -s libchilli.so.0.0.0 libchilli.so; }; })
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/libchilli.lai /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libchilli.la
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/libchilli.a /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libchilli.a
OpenWrt-libtool: install: chmod 644 /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libchilli.a
OpenWrt-libtool: install: aarch64-openwrt-linux-musl-gcc-ranlib /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/libchilli.a
OpenWrt-libtool: install: warning: remember to run `libtool --finish /usr/lib'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/sbin'
  /bin/bash ../libtool   --mode=install /openwrt/staging_dir/host/bin/install -c chilli chilli_response chilli_radconfig chilli_opt chilli_query '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/sbin'
OpenWrt-libtool: install: warning: `libchilli.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `../bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/chilli /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/sbin/chilli
OpenWrt-libtool: install: warning: `libchilli.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `../bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/chilli_response /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/sbin/chilli_response
OpenWrt-libtool: install: warning: `libchilli.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `../bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/chilli_radconfig /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/sbin/chilli_radconfig
OpenWrt-libtool: install: warning: `libchilli.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `../bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/chilli_opt /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/sbin/chilli_opt
OpenWrt-libtool: install: warning: `libchilli.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: warning: `../bstring/libbstring.la' has not been installed in `/usr/lib'
OpenWrt-libtool: install: /openwrt/staging_dir/host/bin/install -c .libs/chilli_query /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/sbin/chilli_query
make  install-exec-hook
make[8]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
make[8]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/include/chilli'
 /openwrt/staging_dir/host/bin/install -c -m 644 chilli.h session.h garden.h radius.h options.h tun.h ippool.h md5.h redir.h dhcp.h iphash.h radius_wispr.h radius_coovachilli.h ssl.h dns.h net.h pkt.h conn.h lookup.h chilli_limits.h cmdline.h debug.h radius_pkt.h ../bstring/bstrlib.h ../config.h system.h cmdsock.h '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/include/chilli'
make[7]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
make[5]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/src'
Making install in doc
make[5]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/doc'
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/doc'
make[6]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/man/man1'
 /openwrt/staging_dir/host/bin/install -c -m 644 chilli_query.1 chilli_response.1 chilli_radconfig.1 chilli_opt.1 chilli_rtmon.1 chilli_redir.1 chilli_proxy.1 chilli_radsec.1 chilli_script.1 '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/man/man1'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/man/man5'
 /openwrt/staging_dir/host/bin/install -c -m 644 chilli.conf.5 chilli-radius.5 '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/man/man5'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/man/man8'
 /openwrt/staging_dir/host/bin/install -c -m 644 chilli.8 '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/man/man8'
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/doc'
make[5]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/doc'
Making install in www
make[5]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/www'
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/www'
make[6]: Nothing to be done for 'install-exec-am'.
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli'
 /openwrt/staging_dir/host/bin/install -c wwwsh '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli/www'
 /openwrt/staging_dir/host/bin/install -c -m 644 chillijs.chi chillijs.chi.sh chilliform.chi chilliform.chi.sh coova.html coova.jpg coova.png wait.gif openid.gif ChilliLibrary.js chilliController.js json_html.tmpl config.sh '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli/www'
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/www'
make[5]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/www'
Making install in conf
make[5]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/conf'
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/conf'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc'
 /openwrt/staging_dir/host/bin/install -c -m 644 chilli.conf '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli'
 /openwrt/staging_dir/host/bin/install -c -m 644 defaults gui-config-default.ini '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli'
 /openwrt/staging_dir/host/bin/install -c functions up.sh down.sh newmulti.sh wpad.dat '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/chilli'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/init.d'
 /openwrt/staging_dir/host/bin/install -c chilli '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/etc/init.d'
 /usr/bin/mkdir -p '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/python'
 /openwrt/staging_dir/host/bin/install -c CoovaChilliLib.py '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-install/usr/lib/python'
make[6]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/conf'
make[5]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/conf'
make[5]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make[6]: Entering directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make[6]: Nothing to be done for 'install-exec-am'.
make[6]: Nothing to be done for 'install-data-am'.
...
make[5]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
make[4]: Leaving directory '/openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6'
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/lib/libbstring.so.0.0.0: shared object
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/lib/libchilli.so.0.0.0: shared object
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/lib/iptables/libxt_coova.so: shared object
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/sbin/chilli_query: executable
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/sbin/chilli: executable
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/sbin/chilli_response: executable
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/sbin/chilli_radconfig: executable
rstrip.sh: /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli/usr/sbin/chilli_opt: executable
Packaged contents of /openwrt/build_dir/target-aarch64_cortex-a53_musl/coova-chilli-1.6/ipkg-aarch64_cortex-a53/coova-chilli into /openwrt/bin/packages/aarch64_cortex-a53/packages/coova-chilli_1.6-1_aarch64_cortex-a53.ipk
Package kmod-ipt-coova is missing dependencies for the following libraries:
x_tables.ko
make[3]: *** [Makefile:162: /openwrt/bin/targets/bcm27xx/bcm2710/packages/kmod-ipt-coova_5.4.128+1.6-1_aarch64_cortex-a53.ipk] Error 1
```
