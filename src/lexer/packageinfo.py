...
class PackageInfoLexer(InfoLexer):
    ...
    def t_DERIVATE(self, t: LexToken):
        r'((Submenu|Menu)[-]Depends|Build[-](Types|Variant|Only)|Kernel[-]Config|Default[-]Variant|Prereq[-]Check|Require[-]User|Package[-](Source[-]Version|(Mirror[-])?Hash)|Menu|Version|Conflicts|Section|Category|Repository|Title|Maintainer|Override|Source|License|LicenseFiles|Type|Submenu|Default|Hidden|ABIVersion):'
